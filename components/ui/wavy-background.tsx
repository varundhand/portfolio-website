...
export const WavyBackground = ({
  ...
  const init = () => {
    ...
    h = ctx.canvas.height = 200; // Set canvas height to 300px
  ...
  const render = () => {
    ctx.clearRect(0, 0, w, h); // Clear the canvas instead of filling the background
    drawWave(6);
    ...
    >
      <canvas
        ...
        style={{
          ...
          // height: "200px", // Set canvas height to 300px
        }}
      ></canvas>
